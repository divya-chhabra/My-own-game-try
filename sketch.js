...
function preload() {
  ...
  // treeCutImage = loadImage("TREE CUT1.png");
  backgroundSound = loadSound("BACKGROUND.mp3");
  dieSound = loadSound("DIE.mp3");
  stormGif = loadImage("stormImage.jpg");
  treeLog = loadImage("tree log2.png");
  //treeLog2 = loadImage("treelog.png");
  //stones = loadImage("stones.png");
  //sampleBackgroundImage = loadAnimation("backgroundImage.jpg","backgroundImage.jpg")
...
function setup() {
  ...
  returnPage = createSprite(width/2, height/2 + 50);
...
function draw() {
  ...
  if (gameState == "gameOver") {
    ...
    boyRunning.visible = false;
    backgroundSprite.changeSprite("blackScreen");
...
function spawnObstacles() {
  if (frameCount % 200 === 0) {
    var obstacle = createSprite(width, height / 2 + 50);
    //obstacle.debug = true;
